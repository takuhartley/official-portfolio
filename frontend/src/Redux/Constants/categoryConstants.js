...
export const CATEGORY_DETAILS_RESET = 'CATEGORY_DETAILS_FAIL'
...
export const CATEGORY_IMAGES_REQUEST = 'CATEGORY_IMAGES_REQUEST'
export const CATEGORY_IMAGES_SUCCESS = 'CATEGORY_IMAGES_SUCCESS'
export const CATEGORY_IMAGES_FAIL = 'CATEGORY_IMAGES_FAIL'
export const CATEGORY_IMAGES_RESET = 'CATEGORY_IMAGES_RESET'
